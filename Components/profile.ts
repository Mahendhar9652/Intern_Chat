...
const allUserLists: UserType[] = JSON.parse(localStorage.getItem("users") || "[]");
const loginUserr: UserType[] = JSON.parse(sessionStorage.getItem("loginUser") || '[]');
const allLoginUserLists: Login[] = JSON.parse(localStorage.getItem("loginUser") || "[]");


// Get the necessary HTML elements
const profileInfo = document.getElementsByClassName('profile-info')[0] as HTMLElement;
const profileEditContainer = document.getElementsByClassName('profile-edit')[0] as HTMLElement;
const profileEditForm = document.getElementsByClassName('profile-form')[0] as HTMLFormElement;
const userImagess = document.getElementById("userImage") as HTMLImageElement;
const emailInput = document.querySelector('#email') as HTMLInputElement;
const imageInput = document.querySelector('#image') as HTMLInputElement;
const bioInput = document.querySelector('#bio') as HTMLInputElement;
...
function profileEdit(profile: string): void {
